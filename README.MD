...
<p align="center">
  ...
  <a href="https://github.com/citccld/vuepress-theme-vdoing/stargazers"><img src="https://img.shields.io/github/stars/xugaoyi/vuepress-theme-vdoing?logo=ReverbNation&logoColor=rgba(255,255,255,.6)" alt="GitHub stars"></a>
  <a href="https://github.com/citccld/vuepress-theme-vdoing/actions?query=workflow%3ACI"><img src="https://github.com/citccld/vuepress-theme-vdoing/workflows/CI/badge.svg" alt="CI"></a>
  <a href="https://github.com/citccld/vuepress-theme-vdoing/actions?query=workflow%3AbaiduPush"><img src="https://github.com/citccld/vuepress-theme-vdoing/workflows/baiduPush/badge.svg" alt="baiduPush"></a>
</p>
...
[**更新日志**](https://github.com/citccld/vuepress-theme-vdoing/releases)
...
```bash
# clone the project
git clone https://github.com/citccld/vuepress-theme-vdoing.git
...
3. 关注公众号`yqyjs666`，回复`前端资源`，可获取 [前端学习资源](https://github.com/citccld/blog-gitalk-comment/wiki/Front-end-Study)
<!-- 4. 轻轻点击一次页面广告 ✨ -->
...
:heart:感谢为这个项目贡献代码的朋友 → [Contributors](https://github.com/citccld/vuepress-theme-vdoing/graphs/contributors)
...
## 许可证
[MIT](https://github.com/citccld/vuepress-theme-vdoing/blob/master/LICENSE)
